...
lib.ssMetadata = [
		{name:"note1_atlas_1", frames: [[0,0,1024,1536]]},
		{name:"note1_atlas_2", frames: [[0,0,1024,1536]]},
		{name:"note1_atlas_3", frames: [[0,0,1024,1536]]},
		{name:"note1_atlas_4", frames: [[0,0,1024,1536]]},
		{name:"note1_atlas_5", frames: [[0,0,1024,1536]]},
		{name:"note1_atlas_6", frames: [[0,0,1024,1536]]},
		{name:"note1_atlas_7", frames: [[0,0,1024,1536]]},
		{name:"note1_atlas_8", frames: [[0,0,1024,1536]]},
		{name:"note1_atlas_9", frames: [[0,0,1024,1536]]},
		{name:"note1_atlas_10", frames: [[0,0,1024,1536]]},
		{name:"note1_atlas_11", frames: [[0,0,1024,1536]]},
		{name:"note1_atlas_12", frames: [[0,0,1024,1536]]}
];
...
(lib.body = function() {
	this.initialize(ss["note1_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.head = function() {
	this.initialize(ss["note1_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.left_arm_feet = function() {
	this.initialize(ss["note1_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.left_arm_hand = function() {
	this.initialize(ss["note1_atlas_4"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.left_handpngcopy = function() {
	this.initialize(ss["note1_atlas_5"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.left_leg_feet = function() {
	this.initialize(ss["note1_atlas_6"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.left_leg_hand = function() {
	this.initialize(ss["note1_atlas_7"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.right_arm_feet = function() {
	this.initialize(ss["note1_atlas_8"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.right_arm_hand = function() {
	this.initialize(ss["note1_atlas_9"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.right_hand = function() {
	this.initialize(ss["note1_atlas_10"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.right_leg_feet = function() {
	this.initialize(ss["note1_atlas_11"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.right_leg_hand = function() {
	this.initialize(ss["note1_atlas_12"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.instance_8.setTransform(475.8,336.15,0.9999,0.9999,6.9998);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true,scaleX:0.9999,scaleY:0.9999,rotation:6.9998,x:475.8,y:336.15},14).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({rotation:12.9999,x:431,y:359.95},14).to({regX:0.1,regY:0.1,rotation:0,x:489.05,y:360.1},16).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({rotation:-15,x:515.95,y:351.65},14).to({rotation:-5.0001,x:489.95,y:359.95},16).wait(2));

	// Layer_10
	this.instance_15 = new lib.Tween5("synched",0);
	this.instance_15.setTransform(479.95,368.95,1,1,-10.9992);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({regX:0.2,regY:0.4,rotation:-26.0005,x:506.05,y:394.35},14).to({regX:0,regY:0.1,rotation:-10.9996,x:479.95,y:369.05},16).wait(2));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(548.7,21.1,640.5999999999999,806.5);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/note1_atlas_1.png", id:"note1_atlas_1"},
		{src:"images/note1_atlas_2.png", id:"note1_atlas_2"},
		{src:"images/note1_atlas_3.png", id:"note1_atlas_3"},
		{src:"images/note1_atlas_4.png", id:"note1_atlas_4"},
		{src:"images/note1_atlas_5.png", id:"note1_atlas_5"},
		{src:"images/note1_atlas_6.png", id:"note1_atlas_6"},
		{src:"images/note1_atlas_7.png", id:"note1_atlas_7"},
		{src:"images/note1_atlas_8.png", id:"note1_atlas_8"},
		{src:"images/note1_atlas_9.png", id:"note1_atlas_9"},
		{src:"images/note1_atlas_10.png", id:"note1_atlas_10"},
		{src:"images/note1_atlas_11.png", id:"note1_atlas_11"},
		{src:"images/note1_atlas_12.png", id:"note1_atlas_12"}
	],
	preloads: []
};
