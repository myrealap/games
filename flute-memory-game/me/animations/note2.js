...
lib.ssMetadata = [
		{name:"note2_atlas_1", frames: [[0,0,1024,1536]]},
		{name:"note2_atlas_2", frames: [[0,0,1024,1536]]},
		{name:"note2_atlas_3", frames: [[0,0,1024,1536]]},
		{name:"note2_atlas_4", frames: [[0,0,1024,1536]]},
		{name:"note2_atlas_5", frames: [[0,0,1024,1536]]},
		{name:"note2_atlas_6", frames: [[0,0,1024,1536]]},
		{name:"note2_atlas_7", frames: [[0,0,1024,1536]]},
		{name:"note2_atlas_8", frames: [[0,0,1024,1536]]},
		{name:"note2_atlas_9", frames: [[0,0,1024,1536]]},
		{name:"note2_atlas_10", frames: [[0,0,1024,1536]]},
		{name:"note2_atlas_11", frames: [[0,0,1024,1536]]},
		{name:"note2_atlas_12", frames: [[0,0,1024,1536]]}
];
...
(lib.body = function() {
	this.initialize(ss["note2_atlas_1"]);
	this.gotoAndStop(0);
...
(lib.head = function() {
	this.initialize(ss["note2_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.left_arm_feet = function() {
	this.initialize(ss["note2_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.left_arm_hand = function() {
	this.initialize(ss["note2_atlas_4"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.left_handpngcopy = function() {
	this.initialize(ss["note2_atlas_5"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.left_leg_feet = function() {
	this.initialize(ss["note2_atlas_6"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.left_leg_hand = function() {
	this.initialize(ss["note2_atlas_7"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.right_arm_feet = function() {
	this.initialize(ss["note2_atlas_8"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.right_arm_hand = function() {
	this.initialize(ss["note2_atlas_9"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.right_hand = function() {
	this.initialize(ss["note2_atlas_10"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.right_leg_feet = function() {
	this.initialize(ss["note2_atlas_11"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.right_leg_hand = function() {
	this.initialize(ss["note2_atlas_12"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.instance_8.setTransform(532.05,383.65,0.9999,0.9999,6.9998);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true,scaleX:0.9999,scaleY:0.9999,rotation:6.9998,x:532.05,y:383.65},14).wait(18));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({regX:0.1,regY:0.2,rotation:7.9993,x:540.95,y:375},14).to({regY:0.1,rotation:0,x:489.05,y:360.1},16).wait(2));

	// body
	this.instance_11 = new lib.body_1();
	this.instance_11.setTransform(490,360,1,1,0,0,0,240,360);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(1).to({rotation:1.4286,x:490.35,y:360.05},0).wait(1).to({rotation:2.8571,x:490.7,y:360},0).wait(1).to({rotation:4.2857,x:491.05,y:360.05},0).wait(1).to({rotation:5.7143,x:491.4,y:360},0).wait(1).to({rotation:7.1429,x:491.8,y:360.05},0).wait(1).to({rotation:8.5714,x:492.1},0).wait(1).to({rotation:10,x:492.5,y:360},0).wait(1).to({rotation:11.4286,x:492.8},0).wait(1).to({rotation:12.8571,x:493.2},0).wait(1).to({rotation:14.2857,x:493.55},0).wait(1).to({rotation:15.7143,x:493.95,y:360.05},0).wait(1).to({rotation:17.1429,x:494.3},0).wait(1).to({rotation:18.5714,x:494.6},0).wait(1).to({rotation:20,x:495},0).wait(1).to({rotation:18.6667,x:494.65,y:359.95},0).wait(1).to({rotation:17.3333,x:494.3,y:359.9},0).wait(1).to({rotation:16,x:493.95,y:359.8},0).wait(1).to({rotation:14.6667,x:493.65,y:359.7},0).wait(1).to({rotation:13.3333,x:493.35},0).wait(1).to({rotation:12,x:492.95,y:359.65},0).wait(1).to({rotation:10.6667,x:492.6,y:359.55},0).wait(1).to({rotation:9.3333,x:492.25,y:359.5},0).wait(1).to({rotation:8,x:491.95,y:359.45},0).wait(1).to({rotation:6.6667,x:491.6,y:359.35},0).wait(1).to({rotation:5.3333,x:491.3,y:359.3},0).wait(1).to({rotation:4,x:490.95,y:359.2},0).wait(1).to({rotation:2.6667,x:490.65,y:359.15},0).wait(1).to({rotation:1.3333,x:490.35,y:359.1},0).wait(1).to({rotation:0,x:490,y:359},0).wait(3));

	// left_feet_arm
	this.instance_12 = new lib.Tween2("synched",0);
	this.instance_12.setTransform(490,360);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({rotation:5.0001,x:512,y:367.95},14).to({rotation:0,x:490,y:360},16).wait(2));

	// Layer_9
	this.instance_13 = new lib.Tween3("synched",0);
	this.instance_13.setTransform(490,360);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({rotation:7.0001,x:512.95,y:374.95},14).to({rotation:0,x:490,y:360},16).wait(2));

	// Layer_4
	this.instance_14 = new lib.Tween4("synched",0);
	this.instance_14.setTransform(489.95,359.95,1,1,-5.9997);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).to({rotation:0,x:503.95,y:351.65},14).to({rotation:-5.0001,x:489.95,y:359.95},16).wait(2));

	// Layer_10
	this.instance_15 = new lib.Tween5("synched",0);
	this.instance_15.setTransform(479.95,368.95,1,1,-10.9992);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({regX:0.2,regY:0.5,rotation:-18.9992,x:471.95,y:384.4},14).to({regX:0,regY:0.1,rotation:-10.9996,x:479.95,y:369.05},16).wait(2));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(548.7,17.4,715.8,819.6);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/note2_atlas_1.png", id:"note2_atlas_1"},
		{src:"images/note2_atlas_2.png", id:"note2_atlas_2"},
		{src:"images/note2_atlas_3.png", id:"note2_atlas_3"},
		{src:"images/note2_atlas_4.png", id:"note2_atlas_4"},
		{src:"images/note2_atlas_5.png", id:"note2_atlas_5"},
		{src:"images/note2_atlas_6.png", id:"note2_atlas_6"},
		{src:"images/note2_atlas_7.png", id:"note2_atlas_7"},
		{src:"images/note2_atlas_8.png", id:"note2_atlas_8"},
		{src:"images/note2_atlas_9.png", id:"note2_atlas_9"},
		{src:"images/note2_atlas_10.png", id:"note2_atlas_10"},
		{src:"images/note2_atlas_11.png", id:"note2_atlas_11"},
		{src:"images/note2_atlas_12.png", id:"note2_atlas_12"}
	],
	preloads: []
};
